...
- `sounds/` — the X16's sounds: 27 WAVs (48 kHz mono) edited from public-domain and CC BY 4.0 recordings: the gunshot from a real indoor 9mm range, most handling sounds from a real Walther PPQ 9mm. `SOURCES.md` lists the original of each file and how it was edited.
